...
<div class="logo">  
      ...
      <div class="menu_nav">
        <ul>
                <li<?php if($cpage==="home") echo " class='active'"?>><a href="index.php">Home</a></li>
                <li<?php if($cpage==="support") echo " class='active'"?>><a href="support.php">Support &#9662;</a>
                    <ul>
                ...
                <li<?php if($cpage==="about") echo " class='active'"?>><a href="about.php">About &#9662;</a>
                    <ul>
                ...
                <li<?php if($cpage==="contact") echo " class='active'"?>><a href="contact.php">Contact Us</a></li>
           <?php
          if(isset($_SESSION['consumer_id']))
            {?>
                <li<?php if($cpage==="account") echo " class='active'"?>><a href='loggedin.php'><span>Account &#9662;</span></a>
                    <ul>
            ...
            {?>
                <li<?php if($cpage==="login") echo " class='active'"?>><a href='login.php'><span>LogIn &#9662;</span></a>
                    <ul>
