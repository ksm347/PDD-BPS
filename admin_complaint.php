    ...
    <div class="content">
        <div class="content_resize">
            <div class="article">
                <h2>Complaints</h2>
                <?php
                    $query_ret="select * from complaints where status='in queue' order by date asc";
                    $qry_ret=  mysqli_query($conn,$query_ret);
                    $num=  mysqli_num_rows($qry_ret);
                    if(!$num)
                        die("No complaints registered.");
                    else {
                ?>
                <table>
                        <tr>
                        ...
                        <tr>
                            <td align="center" colspan="4">
                                <form action="admin_process_complaint.php" method="POST">
