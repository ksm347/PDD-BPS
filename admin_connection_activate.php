  ...
  <div class="header">
    ...
    <div class="content">
        <div class="content_resize">
            <div class="article">
                <h2>Activate Temporarily Deactivated Connections.</h2>
                <?php
                    $query_ret="select * from service where status='0' order by end_date asc";
                    $qry_ret=  mysqli_query($conn,$query_ret);
                    $num=  mysqli_num_rows($qry_ret);
                    if(!$num)
                        die("No services deactivated.");
                ?>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td align="center" colspan="4">
                                <form action="admin_process_connection_activate.php" method="POST">
                    ...
                    <br>
                <a href="admin_connection_deactivate.php">Deactivate Service Here</a>
            </div>
            <div class="clr"></div>
        </div>
    </div>
